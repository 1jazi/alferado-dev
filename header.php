...
<script>
  ...
  jQuery(document).ready(function() {
    jQuery('.page-id-123 .wp-block-bwgb-product-categories div div ul li a[href*="https://alefredobooks.com/book-category/sell-your-books"]').attr('href' , 'https://alefredobooks.com/sell-your-books/');

    jQuery(".woocommerce-product-attributes-item--attribute_pa_book-status").clone().appendTo("#tab-additional_product_details .woocommerce-product-attributes.shop_attributes tbody");
  });
</script>